    ...
    describe "UnionType" do
      ...
      context 'when used with a single type' do
        ...
        it 'works as expected' do
          expect(union_type.to_typescript).to eql("string")
        end
      end
      ...
      context 'when used with two types' do
        ...
        it 'works as expected' do
          expect(union_type.to_typescript).to eql("string|number")
        end
      end
      ...
      context 'when used with a |Nil' do
        ...
        it 'works as expected' do
          expect(union_type.to_typescript).to eql("string|number|null")
        end
      end
      ...
      context 'when used with a TrueClass|FalseClass' do
        ...
        it 'works as expected' do
          expect(union_type.to_typescript).to eql("boolean")
        end
      end
